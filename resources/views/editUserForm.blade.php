...
<div class="container">
    ...
    <form action="{{URL::to('admin/editUser')}}/{{$user->uId}}" method="post" id="newUserForm">
        <table cellpadding="10">
            <tr>
                <td> Full Name:</td>
                <td><input type="text" name="fname" id="fname" value="{{$user->fname}}" required class="fields"></td>
                <td>Username:</td>
                <td><input type="text" name="username" id="username" value="{{$user->username}}" required class="fields"></td>
            </tr>
            <tr>
                <td>Email:</td>
                <td><input type="email" name="email" id="email" value="{{$user->email}}" required class="fields"></td>
                <td>Mobile Number:</td>

...
$parentPages = DB::table("sp_adminpages")->where("parentId", 4)->get();
?>
@section("content")
    ...
    @endforeach
    @endif
    <!-- <li ng-repeat="page in pages"><a href="{{URL::to('/')}}/@{{page.pageURL}}" ng-if="page.parentId==4 && page.isActive==1">@{{page.pageName}}</a></li> -->

...
<div ng-app="editServiceModule" ng-controller="editServiceController">
    <div class="row">
                ...
                <table style="font-size:12px">
                    <tbody>
                        <tr>
                            ...
                            <th>Description</th>
                            <td colspan="4"><input type="text" ng-model="service.description" name="productDescription" id="productDescription" style="width:100%" none=""></td>
                        ...
                        <tr>
                            ...
                            <th>Sales Tax</th>
                            <td><input type="number" name="salesTax" id="salesTax" style="width:100%" ng-model="service.salesTax"></td>
                        </tr>
                        <tr>
                            <th>Income Tax</th>
                            ...
                            <th>Value</th>
                            <td>
                                <input style="width:100%" type="text" none="" name="valueProduct" id="valueProduct" placeholder="Per Kg" value="{{($service->Detail() != null ? $service->Detail()->valueProduct : '')}}">
                            </td>
                            <th></th>
                            <td align="right">
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <input type="text" none="" name="qualityParameter" id="qualityParameter" style="width:100%" ng-model="service.qualityParameter" />
                            </td>

                        </tr>
                        <tr>
                            <th>FTA</th>
                            <td><input type="text" none="" name="fta" id="fta" value="{{($service->Detail() != null ? $service->Detail()->fta : '')}}" ;="">
                            </td>
                            <th>Custom Value</th>
                            <td><input type="number" none="" name="valueAtCustom" id="valueAtCustom" ng-model="service.customWeight" ;=""></td>
                            <td>AST</td>
                        ...
                        <tr>
                            <td colspan="6" align="right">
                                <span ng-show="!loading">
                                    <input type="button" value="Save Changes" ng-click="saveChanges()" class="btn btn-primary btn-sm">
                                </span>
                                <span ng-show="loading">
        ...
        <div class="col-lg-4 col-md-4">
            ...
            @endphp
            <img src="{{URL::to('/storage/app/cms/')}}/{{$imageURL}}" style="max-height:200px" id="displayImage" alt="Image Not Available" class="img-thumbnail">
    ...
    <div class="row">
        <div class="col-lg-7 col-md-6">
            ...
            <table class="jumbotron table table-bordered" style="margin-top:5px; padding:0px 0px; font-size:11px;">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid black"><input type="number" name="sindhExcise" ng-model="service.sindhExcise" id="sindhEx">
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid black"></td>
                        <td style="border:1px solid black" id="portRent">
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid black"></td>
                        <td style="border:1px solid black" id="containerRent">
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid black"></td>
                        <td style="border:1px solid black" id="insuranceCharges">
                    ...
                    <tr>
                        ...
                        <td style="border:1px solid black"></td>
                        <td style="border:1px solid black" id="agencyCommission">

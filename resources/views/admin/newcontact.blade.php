...
@section("contacts_content")
    ...
    <div ng-app="contactModule" ng-controller="contactController">Select any Contact Type
        <select ng-options="item as item.name for item in types track by item.id" ng-change="fetchTypeInfo()"
                ng-model="selectedType"></select>
        ...
        <div ng-show="showForm">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <select ng-model="selectedService" ng-change="getSelectedService()"
                                ng-options="item as item.name for item in services track by item.id"></select>
                    </td>
                ...
                <tr>
                    ...
                    <td align="right">
                        <span id="dataToggle" ng-show="!isSave"><input type="button" value="Register"

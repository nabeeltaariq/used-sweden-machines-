...
<form action="" method="post" id="form-sub" enctype="multipart/form-data" class="desktop_contact_form">
  ...
  <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
    <tbody>
      ...
      <tr>
        <td width="110" height="22" align="left" valign="top" style="border-right:1px solid #ccc">
          <div align="left"><span class="kontakt-form-text">Company</span><span class="kontakt-form-text"> :</span> </div>
        </td>
        <td width="30" height="22" align="center" valign="middle"></td>
        <td height="22" align="left" valign="top"><label for="textfield"></label>
          <input name="company" type="text" class="kontakt-text" id="company" style="width:80%;margin-bottom:2px" value="">
        </td>
      </tr>
      <tr>
        <td width="110" height="22" align="left" valign="top" style="border-right:1px solid #ccc">
          <div align="left"><span class="kontakt-form-text">Name</span><span class="kontakt-info">*</span><span class="kontakt-form-text">:</span> </div>
        </td>
        <td width="30" height="22" align="center" valign="middle"></td>
      ...
      <tr>
        ...
        <td width="110" height="22" align="left" valign="top" style="border-right:1px solid #ccc">
          <div align="left"><span class="kontakt-form-text">First Name :</span> </div>
        </td>
      ...
      <tr>
        <td width="110" height="22" align="left" valign="top" style="border-right:1px solid #ccc">
          <div align="left"><span class="kontakt-form-text">E-Mail</span><span class="kontakt-info">*</span><span class="kontakt-form-text">: </span></div>
        </td>
        <td width="30" height="22" align="center" valign="middle"></td>
      ...
      <tr>
        <td width="110" height="" align="left" valign="top" style="border-right:1px solid #ccc">
          <div align="left"><span class="kontakt-form-text">Machine Name</span><span class="kontakt-info">*</span><span class="kontakt-form-text">:</span></div>
        </td>
      ...
      <tr>
        <td width="110" height="" align="left" valign="top" style="border-right:1px solid #ccc">
          <div align="left"><span class="kontakt-form-text">Technical Secifications</span><span class="kontakt-info">*</span><span class="kontakt-form-text">:</span></div>
        </td>
        <td width="30" height="" align="center" valign="top"></td>
        <td height="" align="left" valign="top"><label for="textarea"></label>
      ...
      <tr>
        <td width="110" height="" align="left" valign="top" style="border-right:1px solid #ccc">
          <div align="left"><span class="kontakt-form-text">Machine Featured Image</span><span class="kontakt-info">*</span><span class="kontakt-form-text">:</span></div>
        </td>
        <td width="30" height="" align="center" valign="top"></td>
        <td height="" align="left" valign="top"><label for="textarea"></label>
      ...
      <tr>
        <td width="110" height="" align="left" valign="top" style="border-right:1px solid #ccc">
          <div align="left"><span class="kontakt-form-text">Machine Other Image</span><span class="kontakt-info">*</span><span class="kontakt-form-text">:</span></div>
        </td>
        <td width="30" height="" align="center" valign="top"></td>
        <td height="" align="left" valign="top"><label for="textarea"></label>

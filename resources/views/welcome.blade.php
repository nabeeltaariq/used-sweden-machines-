...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body form-group" style="top:-14px;">
                <button type="button" style="color:#034375;float:right;background-color:white;border-color:white;" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <div class="form-group">
                    ...
                    <input type="submit" value="Subscribe" class="btn btn-primary" style="background-color:#fbca01;color:#034375;float:right;margin:10px;">

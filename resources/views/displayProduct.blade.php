          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="100000000">
              ...
              <div class="carousel-inner border-class-thinner" style="height: 310px;">
                  <div class="item active">
                      ...
                      <img src="{{URL::to('storage/app/products/'.$product->image)}}" data-toggle="modal" data-target="#myModalbig" class="img-responsive model-images" style="height:310px;width:425px;">
                  ...
                  <div class="item">
                      ...
                      <img src="{{URL::to('storage/app/products/'.$thumb->file_name)}}" data-toggle="modal" data-target="#myModalbig" class="img-responsive" style="width:425px;height: 310px">
      ...
      <div class="modal-dialog" style="height:486px;width:600px">
          ...
          <div class="modal-content" style="height:486px;width:600px">
            ...
            :auto">
                  ...
                  <div id="myCarousel4" class="carousel slide" data-ride="carousel" data-interval="100000000" style="height:500px;width:600px">
                      <!-- Indicators -->
                      ...
                      <div class="carousel-inner " style="height:486px;width:600px;border:10px solid white">
                          ...
                          @foreach($allThumbs as $thumb)
                          <div class="item">
                              <img src="{{URL::to('storage/app/products/'.$thumb->file_name)}}" class="img-responsive" style="width:600px;height: 486px">

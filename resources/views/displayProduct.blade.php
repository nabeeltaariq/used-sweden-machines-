            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="100000000">
                ...
                <div class="carousel-inner border-class-thinner" style="height: 310px;">
                    <div class="item active">
                            ...
                            <img src="{{URL::to('storage/app/products/'.$product->image)}}"  class="img-responsive" style="height:370px;width:100%;">
        ...
        <div class="modal-content" style="height
            ...
            :600px">
                ...
                <div class="carousel-inner border-class" style="height: 600px;">
                    ...
                    @foreach($allThumbs as $thumb)
                        <div class="item">
                            <img src="{{URL::to('storage/app/products/'.$thumb->file_name)}}"  class="img-responsive" style="height: 600px;width:100%;">

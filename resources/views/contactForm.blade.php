            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 p-0">
                    ...
                    <form id="desktop-contact-form">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="background: none repeat scroll 0 0 rgba(53, 147, 175, 0.06);width:88%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="background-color:white" width="110" height="22" align="left" valign="top" style="">
                                        <div align="left">
                                            <span class="kontakt-form-text">E-Mail*</span>
                                        </div>
                                    </td>
              ...
              color: #034375;
               ...
               background: linear-gradient(90deg, #FBCA01 0%,#FBCA01 100%);">Contact Us</h3>
                    ...
                    <div style="margin-top:15px;">
                        ...
                        <div id="vcard"><a href="{{URL::to('/public/imgs/Sweden Machine.vcf')}}"><img src="{{URL::to('/public/imgs/vcard1.png')}}" alt="Download vcard" style="width:39%;">

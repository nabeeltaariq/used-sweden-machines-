      ...
      <div>
        ...
        <div style="background-color:##034375;" class="collapse navbar-collapse navbar-color" id="bs-example-navbar-collapse-1">
          ...
          color: #ffdd00;">Online Shop</span> </a></li>
            ...
            <li id="right-align"><a class="{{(Request::path() == 'cart' ? 'active' : '')}}" href="{{URL::to('cart')}}" style="color:white;background-color:{{(Request::session()->has('cartData') ?  'maroon' : 'none')}}"><span class="fas fa-shopping-cart"></span> Cart <sup class="totalItems">{{(Request::session()->has("cartData") ? count(Request::session()->get("cartData")) : '')}}</sup> </a></li>

...
//     s.id = '3bb1839c-38bd-41c2-b566-335fc229bef2';
...
//   })();
 ...
 <script type="text/javascript">
  ...
  window.zESettings = {
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-165141480-1"></script>
    <script>
    ...
    <link rel="stylesheet" href="{{URL::to('css/jquery.mThumbnailScroller.css')}}">
    <!-- jQuery library -->
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::to('css/lightbox.min.css')}}"/>
    ...
    fbq('init', '552704218766782');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=552704218766782&ev=PageView&noscript=1"
    /></noscript>
...
padding-bottom:30px;
    ...
    .bannerRow
    {
    background:url("{{asset('imgs/banner1.png')}}") no-repeat;
...
@media (max-width: 980px) {
  ...
  <body class="set" >
<!--<div id="cookie_consent" style="width:100%;background-color:#034375;z-index:9;position:absolute; opacity: 0.9;color:white;padding:20px;display:none;">-->
<!--    <button onclick="clicked()" id = "x">-->
<!--            X-->
<!--        </button>-->
<!--    <h3>Cookies</h3>-->
<!--    <p>We and selected partners, use cookies or similar technologies as specified in the cookie policy.-->
<!--You can consent to the use of such technologies by closing this notice, by scrolling this page, by interacting with any link or button outside of this notice or by continuing to browse otherwise.</p>-->
<!--</div>-->
...
screenSize(x) 
x.addListener(screenSize) // Call listener function at run time
...
// ?>
  ...
  <script src="{{URL::to('/public/js/lightbox-plus-jquery.js')}}"></script>

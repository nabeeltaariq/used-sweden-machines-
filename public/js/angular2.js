...
(function (z) {
    ...
    function Ia(a, b, d) {
        function c(a, b, c) {
            ...
            } else if (Pc(a)) for (f in a) b[f] = e(a[f], c); else if (a && "function" === typeof a.hasOwnProperty) for (f in a) a.hasOwnProperty(f) &&
    ...
    function Zc(a, b) {
        ...
        var f = {}, g = /^\s*directive:\s*([\w-]+)\s+(.*)$/, k = /(([\w-]+)(?::([^;]+))?;?)/,
            h = Ae("ngSrc,ngSrcset,src,srcset"), l = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/, m = /^(on[a-z]+|formaction)$/,
            p = T();
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", function (a, b, c, e, p, M, L, u, R) {
            ...
            function Xa(a, b, c, d, e, f) {
                ...
                for (var h = [], k = H(a) || a instanceof x, l, m, p, I, n, t = 0; t < a.length; t++) {
                    ...
                    (f = m.length ? aa(m, a[t], l, b, c, null, [], [], f) :
                ...
                switch (a.nodeType) {
                    case 1:
                        ...
                        for (var l, m, n, t, J, s = a.attributes, v = 0, G = s && s.length; v < G; v++) {
                            ...
                            t = l.value;
                            n = xa(m.toLowerCase());
                            (J = n.match(Ra)) ? (r = "Attr" === J[1], y = "Prop" === J[1],
                                u = "On" === J[1], m = m.replace(rd, "").toLowerCase().substr(4 + J[1].length).replace(/_(.)/g, function (a, b) {
                                return b.toUpperCase()
            ...
            function U(a, b, c) {
                ...
                if (b && a.hasAttribute && a.hasAttribute(b)) {
                    do {
                        ...
                        1 === a.nodeType && (a.hasAttribute(b) && e++, a.hasAttribute(c) &&
                        e--);
                        d.push(a);
                        a = a.nextSibling
                    } while (0 < e)
            ...
            function aa(a, b, d, e, f, g, h, k, l) {
                ...
                function p(a, e, f, g, l) {
                    ...
                    s && (da.$$addScopeInfo(Q,
                        y, !0, !(v && (v === s || v === s.$$originalDirective))), da.$$addScopeClass(Q, !0), y.$$isolateBindings = s.$$isolateBindings, u = Da(e, g, y, y.$$isolateBindings, s), u.removeWatches && y.$on("$destroy", u.removeWatches));
                    for (n in P) {
                        u = J[n];
                        L = P[n];
                ...
                for (var n = -Number.MAX_VALUE,
                    ...
                    if (O = u.transclude) if (G = !0, u.$$tlb || (ba("transclusion", L, u, y), L = u), "element" === O) N = !0, n = u.priority, M = y, y = d.$$element = x(da.$$createComment(Q, d[Q])), b = y[0], oa(f, Ha.call(M, 0), b), R = Z(Jb, M, e, n, g && g.name, {nonTlbTranscludeDirective: L}); else {
                        var ka = T();
                        if (D(O)) {
                    ...
                    if (u.template) if (P =
                        !0, ba("template", v, u, y), v = u, O = B(u.template) ? u.template(y, d) : u.template, O = Na(O), u.replace) {
                        g = u;
            ...
            function fa(a, b, c) {
                for (var d = 0, e = a.length; d < e; d++) a[d] = bc(a[d], {$$isolateScope: b, $$newScope: c})
            }
    ...
    function Sf() {
        ...
        this.$get = ["$browser", "$httpBackend", "$$cookieReader",
            "$cacheFactory", "$rootScope", "$q", "$injector", "$sce", function (e, f, g, k, h, l, m, p) {
                function n(b) {
                    ...
                    if (!C(p.valueOf(b.url))) throw F("$http")("badreq",
                        b.url);
                    var g = S({
                        method: "get",
                ...
                function s(c, d) {
                    ...
                    R && (q = R.get(O), w(q) ? q && B(q.then) ? q.then(s,
                        s) : H(q) ? m(q[1], q[0], ja(q[2]), q[3], q[4]) : m(q, 200, {}, "OK", "complete") : R.put(O, u));
    ...
    function Pg(a, b, d, c, e) {
        ...
        return function (e, k, h, l, m, p, n, s, G, t) {
            ...
            k = k || a.url();
            if ("jsonp" === K(e)) var q = c.createCallback(k), pa = f(k, q, function (a,
                                                                                      b) {
    ...
    function Qf() {
        this.$get =
            ["$$intervalFactory", "$window", function (a, b) {
                var d = {}, c = function (a) {
                    b.clearInterval(a);
                    delete d[a]
                }, e = a(function (a, c, e) {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (d, c, e, f, g) {
            ...
            c.onUrlChange(function (a, b) {
                yc(a, r) ? (d.$evalAsync(function () {
                    ...
                    m.$$parse(a);
                    m.$$state = b;
                    f = d.$broadcast("$locationChangeStart",
    ...
    function $f() {
        ...
        this.$get = ["$filter", function (e) {
            ...
            function h(a, b, c, d, e) {
                ...
                var h = d.literal ? l : w, k, m, n = d.$$intercepted ||
                    d, s = d.$$interceptor || Ta, u = d.inputs && !n.inputs;
                g.literal = d.literal;
        ...
        this.$get = ["$exceptionHandler", "$parse", "$browser", function (f, g, k) {
            ...
            m.prototype = {
                constructor: m, $new: function (b, c) {
                    ...
                    var h = this, k = h.$$watchers, l = {fn: b, last: G, get: f, exp: e || a, eq: !!d};
                    c = null;
                    ...
                    do {
                        ...
                        a:do {
                            if (n = !q.$$suspended && q.$$watchers) for (n.$$digestWatchIndex = n.length; n.$$digestWatchIndex--;) try {
                                if (a =
                                    n[n.$$digestWatchIndex]) if (m = a.get, (g = m(q)) !== (h = a.last) && !(a.eq ? va(g, h) : Y(g) && Y(h))) s = !0, c = a, a.last = a.eq ? Ia(g, null) : g, l = a.fn, l(g, h === G ? g : h, q), 5 > r && (A = 4 - r, N[A] || (N[A] = []), N[A].push({
    ...
    function fg() {
        this.$get = ["$window", "$document", function (a, b) {
            var d = {},
                ...
                e = fa((/android (\d+)/.exec(K((a.navigator || {}).userAgent)) ||
                    [])[1]), f = /Boxee/i.test((a.navigator || {}).userAgent), g = b[0] || {},
    ...
    var Xb = {objectMaxDepth: 5, urlErrorParamsEnabled: !0}, ke = /^\/(.+)\/([a-z]*)$/,
        ta = Object.prototype.hasOwnProperty, K = function (a) {
            return C(a) ? a.toLowerCase() : a
        }, vb = function (a) {
            return C(a) ? a.toUpperCase() : a
        }, wa, x, sb, Ha = [].slice, Kg = [].splice, ph = [].push, la = Object.prototype.toString,
        Rc = Object.getPrototypeOf,
        oa = F("ng"), ca = z.angular || (z.angular = {}), lc, qb = 0;
    ...
    var ze = /^\[object (?:Uint8|Uint8Clamped|Uint16|Uint32|Int8|Int16|Int32|Float32|Float64)Array]$/,
        ...
        Ie = /[A-Z]/g, Yc = !1, Pa = 3,
        Pe = {full: "1.8.0", major: 1, minor: 8, dot: 0, codeName: "nested-vaccination"};
    U.expando = "ng339";
    var Ka = U.cache = {}, ug = 1;
    U._data = function (a) {
        return this.cache[a[this.expando]] || {}
    };
    var qg = /-([a-z])/g, qh = /^-ms-/, Bb = {mouseleave: "mouseout", mouseenter: "mouseover"}, oc = F("jqLite"),
        tg = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, nc = /<|&#?\w+;/, rg = /<([\w:-]+)/,
        sg = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, qa = {
    ...
    var zg = z.Node.prototype.contains || function (a) {
        ...
        }, length: 0, push: ph, sort: [].sort, splice: [].splice
    }, Hb = {};
    ...
    r({
        data: sc, inheritedData: Fb, scope: function (a) {
    ...
    r({
        removeData: rc, on: function (a, b, d, c) {
        ...
        }, clone: qc, triggerHandler: function (a, b, d) {
    ...
    var Ib = pd, og = [function () {
        ...
        }], Bg = /^([^(]+?)=>/, Cg = /^[^(]*\(\s*([^)]*)\)/m, sh = /,/, th = /^\s*(_?)(\S+?)\1\s*$/,
        Ag = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Ca = F("$injector");
    ...
    var rd = /^((?:x|data)[:\-_])/i, Jg =
            /[:\-_]+(.)/g, xd = F("$controller"), wd = /^(\S+)(\s+as\s+([\w$]+))?$/, Of = function () {
        ...
        }, yd = "application/json", xc = {"Content-Type": yd + ";charset=utf-8"}, Mg = /^\[|^\{(?!\{)/,
        Ng = {"[": /]$/, "{": /}$/}, Lg = /^\)]\}',?\n/, Lb = F("$http"),
    ...
    var Qg = F("$interval"), Xf = function () {
        ...
        }, uh = /^([^?#]*)(\?([^#]*))?(#(.*))?$/, Rg = {http: 80, https: 443, ftp: 21}, kb = F("$location"),
        Sg = /^\s*[\\/]{2,}/, vh = {
        ...
        isValidIdentifierContinue: function (a, b) {
            ...
            for (var d = "", c = a, e = !1; this.index < this.text.length;) {
                ...
                if (e) "u" === f ? (e = this.text.substring(this.index +
                    1, this.index + 5), e.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + e + "]"), this.index += 4, d += String.fromCharCode(parseInt(e, 16))) : d += wh[f] || f, e = !1; else if ("\\" === f) e = !0; else {
                    if (f === a) {
                        this.index++;
    ...
    var Ea = F("$sce"),
        ...
        Dc = /_([a-z])/g, Zg = F("$templateRequest"), $g = F("$timeout"), aa = z.document.createElement("a"),
        Qd = ga(z.location.href), Na;
    aa.href = "http://[::1]";
    ...
    var oe = function (a) {
        ...
        }, Se = oe(), df = oe(!0), mh = /^\d{4,}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+(?:[+-][0-2]\d:[0-5]\d|Z)$/,
        ...
        nh = /^\s*(-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/, pe = /^(\d{4,})-(\d{2})-(\d{2})$/,
        qe = /^(\d{4,})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Oc = /^(\d{4,})-W(\d\d)$/,
        re = /^(\d{4,})-(\d\d)$/, se = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, ee = T();
    ...
    var te = {
            ...
            range: function (a, b, d, c, e, f) {
                ...
                fe(c);
                Sa(a, b, d, c, e, f);
                var m = c.$$hasNativeValidators && "range" === b[0].type, p = m ? 0 : void 0, n = m ? 100 : void 0,
                    s = m ? 1 : void 0, r = b[0].validity;
                a = w(d.min);
                e = w(d.max);
                f = w(d.step);
                var q = c.$render;
    ...
    Sb.prototype = {
        $$initGetterSetters: function () {
            ...
            (function () {
                var a = h.$$parserName;
                if (A(h.$$parserValid)) f(a, null); else return h.$$parserValid || (r(h.$validators, function (a,
                                                                                                               b) {
                    f(b, null)
    ...
    var yf = function () {
        ...
        }, jf = Ra({terminal: !0, priority: 1E3}), Ch = F("ngOptions"),
        ...
        sf = ["$compile", "$document", "$parse", function (a, b, d) {
            function c(a, b, c) {
                ...
                var t = a && d(a) || b, w = q && d(q), v = q ? function (a, b) {
                    ...
                    x = function (a, b) {
                        return v(a, B(a, b))
                    }, A = d(p[2] || p[1]), y = d(p[3] || ""), J = d(p[4] || ""), I = d(p[8]), z = {},
                    B = r ? function (a, b) {
                        z[r] = b;
                        z[n] = a;
                        return z
                ...
                return {
                    trackBy: q, getTrackByValue: x, getWatchables: d(I, function (a) {
                        ...
                        for (var a = [], b = {}, d = I(c) || [], g = f(d), k = g.length, n = 0; n < k; n++) {
                            var p = d ===
                                g ? n : g[n], r = B(d[p], p), s = t(c, r), p = v(s, r), w = A(c, r), z = y(c, r),
                                r = J(c, r), s = new e(p, s, w, z, r);
                            a.push(s);
                            b[p] = s
                        }
                        return {
                ...
                return {
                    link: function (f, g, k) {
                        ...
                        var l = k.count, m = k.$attr.when && g.attr(k.$attr.when), p = k.offset || 0, n = f.$eval(m) || {},
                            q = {}, w = b.startSymbol(), t = b.endSymbol(), x = w + l + "-" + p + t, v = ca.noop, z;
                        r(k, function (a, b) {
                            var c = e.exec(b);
